...
TEST(PrepareTest, FormatPart_ComparisonOperators) {
  ...
  typedef fmt::internal::prepared_format_specs<char> prepared_specs;
...
TEST(
  ...
  fmt::internal::prepared_format_specs<char> specs{};
  ...
  fmt::internal::null_terminating_iterator<char> it(
      specification_begin_it, specification_test_text.end());
  handler.on_format_specs(it);
}
