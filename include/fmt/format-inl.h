...
namespace internal {
template <typename T>
int char_traits<char>::format_float(char *buffer, std::size_t size,
...
template <typename T>
int char_traits<wchar_t>::format_float(wchar_t *buffer, std::size_t size,
...
FMT_FUNC bool grisu2_round(char *buffer, size_t &size, size_t max_digits,
...
FMT_FUNC bool grisu2_gen_digits(char *buffer, size_t &size, uint32_t hi,
...
template <typename Handler>
FMT_FUNC void grisu2_prettify(const gen_digits_params &params, size_t size,
