...
struct is_range_<
    T, typename std::conditional<
           false, conditional_helper<decltype(internal::declval<T>().begin()),
...
struct formatter<TupleT, Char, typename std::enable_if<
                                   fmt::is_tuple_like<TupleT>::value>::type> {
 private:
  ...
  struct format_each {
    ...
    void operator()(const T &v) {
      ...
      format_to(out, internal::format_str_quoted(
